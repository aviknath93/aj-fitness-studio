            ...
            <div className="container mx-auto px-4 py-16">
                    ...
                    <div className="space-y-6 md:col-span-2">
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="flex flex-col">
                                <span className="text-2xl font-bold">AJ Fitness</span>
                ...
                <div className="grid md:grid-cols-3 gap-8 mt-12 pt-12 border-t border-white/10">
                    <div className="flex items-start space-x-3">
                        <svg className="w-6 h-6 text-primary shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="border-t border-white/10">
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        {/* Copyright */}
                        <p className="text-gray-300 text-sm">
                            © {currentYear} AJ Fitness Studio. All rights reserved.
                        </p>
